...
$title       = $attributes['title'] ?? 'Kiinnostuitko? Ota yhteyttä!';
$description = $attributes['description'] ?? 'Kerro meille projektistasi, niin palataan asiaan pikimmiten.';
...
?>
<section <?php echo get_block_wrapper_attributes( [ 'class' => 'block block-pricing-cta has-unified-padding-if-stacked' ] ); ?>>
  <div class="container">
    <div class="cta-box">
