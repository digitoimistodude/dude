      ...
      if (
        ...
        if (thisElement.parentNode.previousElementSibling) {
          ...
          if (previousItem.querySelector('.sub-menu')) {
            ...
            previousItem.querySelector('.dropdown-toggle').setAttribute('aria-label', `${dude_screenReaderText.expand_for} ${previousItem.querySelector('.dropdown-item').innerText}`);
