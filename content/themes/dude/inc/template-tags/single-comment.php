 ...
 * @Last Modified time: 2022-08-30 19:47:47
 *
 * @package dude
    ...
    <div id="comment-<?php comment_ID(); ?>">
      ...
      <p class="comment-time">
        <a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>">
          ...
          <time datetime="<?php echo esc_attr( get_comment_date( 'c' ) ); ?>"><?php printf( esc_attr( __( '%1$s at %2$s', 'dude' ) ), esc_attr( get_comment_date() ), esc_attr( get_comment_time() ) ); ?></time>
        </a>
      </p>
