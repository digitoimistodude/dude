 ...
 * @Last Modified time: 2022-10-12 13:06:42
 *
 * @package dude
 */
...
<footer id="colophon" class="site-footer has-dark-bg">
  ...
  <div class="container">
    ...
    <div class="bottom-bar">
      <p class="copyright"><a class="no-external-link-indicator" href="https://www.asiakastieto.fi/yritykset/fi/digitoimisto-dude-oy/25480215/yleiskuva" aria-label="Ulospäin vievä linkki: Digitoimisto Duden Asiakastieto-profiili">Digitoimisto Dude Oy</a> - Digitaalinen mainostoimisto, Jyväskylä. Löydät meidät <a class="no-external-link-indicator" href="https://www.facebook.com/digitoimistodude">Facebookista</a>, <a class="no-external-link-indicator" href="https://twitter.com/dudetoimisto">Twitteristä</a>, <a class="no-external-link-indicator" href="https://mementomori.social/@dude" rel="me">Mastodonista</a>, <a class="no-external-link-indicator" href="https://www.linkedin.com/company/digitoimisto-dude-oy">LinkedInistä</a>, <a class="no-external-link-indicator" href="https://www.instagram.com/digitoimistodude/">Instagramista</a> ja <a class="no-external-link-indicator" href="https://github.com/digitoimistodude">Githubista</a>. &mdash; <a href="https://handbook.dude.fi/tietosuojaseloste">Tietosuojaseloste</a> &mdash; <button data-cc="c-settings" class="cc-link cookie-settings">Evästeasetukset</button>
      </p>
