...
- Remove text gradient from front page reference titles, mint on hover, Ref: DEV-641
- Add dark overlay on hero in light mode for accessibility, Ref: DEV-641
- Remove overflow hidden from block-hero, keep on mobile, Ref: DEV-641
- Fix seam between hero and references by clearing background-image, Ref: DEV-641
...
- Add grid layout to block-editor-block-list\_\_layout for two-column editor display of gradient box, Ref: DEV-701
...
- Add \_\_nextHasNoMarginBottom prop to ToggleControl components to fix deprecation warnings, Ref: DEV-701
- Add **next40pxDefaultSize and **nextHasNoMarginBottom props to TextControl components, Ref: DEV-701
